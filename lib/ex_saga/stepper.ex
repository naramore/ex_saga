defmodule ExSaga.Stepper do
  ...
  @doc """
  """
  @callback handle_sublevel_step(stepable :: Stepable.t, event :: Event.t, opts :: Stepable.opts) :: Stepable.stage_result | Stepable.step_result | nil

  @doc """
  """
  @callback handle_step(stepable :: Stepable.t, event :: Event.t, opts :: Stepable.opts) :: Stepable.stage_result | Stepable.step_result | nil
  ...
  @doc """
  """
  @spec step(stepper :: module, Stepable.t, Event.t, Stepable.opts) :: Stepable.stage_result | Stepable.step_result
  ...
  def step(_stepper, %{state: %State{hooks_left: []}} = stepable, %Event{name: [_, :retry, _]} = event, opts) do
    case Retry.step(stepable.state, event, opts) do
      ...
      {:retry, event, state} ->
        ...
        event = Event.update(event, name: [:starting, :transaction],
